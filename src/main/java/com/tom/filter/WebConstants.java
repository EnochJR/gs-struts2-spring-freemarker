...
public class WebConstants {
    ...
    public static String WEBSITE_ROOT = new File(FilenameUtils.getPathNoEndSeparator(WebConstants.class.getClassLoader().getResource("config").getFile())).getParentFile().getParent();
